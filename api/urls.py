...
from .views import (AdditionalServicesAPIView, AirlineUsersViewSet,
                    BaggageViewSet, BoardingPassViewSet, CheckInViewSet,
                    ComfortViewSet, CurrentUserAPIView, MealViewSet,
                    TicketViewSet, UserTicketsAPIView, CancelTicketAPIView,
                    StripeWebhookView)
...
urlpatterns = [
    ...
    path('additional_services/', AdditionalServicesAPIView.as_view(), name='additional_services'),
