...
from .models import AirlineUser, Airplane, Flight, Ticket, BoardingPass, CheckIn, DietaryOption, Meal, Comfort, Baggage
...
class TicketAdmin(admin.ModelAdmin):
    ...
    def has_view_permission(self, request, obj=None):
        ...
        if request.user.role in ['supervisor', 'checkin_manager', 'gate_manager']:
            return True
        return obj is not None and request.user.role == 'passenger' and obj.passenger == request.user
